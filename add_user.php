...
if (isset($_POST['btn-guardar'])) 
{
    ...
    if ($rut == "" && $apellido == "" && $nombre == "" && $nacionalidad == "-1" && $fchNacimiento == "" && $sexo == "" && $username == "" && $password == "") {
        echo '<script>
    ...
    $sql ="INSERT INTO usuario(rut, apll, nom, nacionalidad, sexo, fchNacimiento, username, userpass) ";
            ...
            <div class="container">
                <form action="<?= htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post" class="row g-3">
                    ...
                    <div class="col-12 d-flex gap-3">
                        <button type="submit" class="btn btn-success btn-sm text-uppercase" name="btn-guardar">guardar</button>
